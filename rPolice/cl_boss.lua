                    ...
                    RageUI.ButtonWithStyle("Retirer argent de société",nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
                        if Selected then
                            ...
                            if amount == nil then
                                ...
                                TriggerServerEvent('five_banque:retraitentreprise', amount, 'police')
                                RefreshpoliceMoney()
                            end
                        end
                    end)
                    ...
                    RageUI.ButtonWithStyle("Déposer argent de société",nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
                        if Selected then
                            ...
                            if amount == nil then
                                ...
                                TriggerServerEvent('five_banque:depotentreprise', amount, 'police')
                                RefreshpoliceMoney()
                            end
                        end
                    end) 
...
function MenuBossPolice()
    TriggerEvent('five_society', "police", false, false)
end
