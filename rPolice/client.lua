...
function Menuf6police()
    ...
    rPolicef5:SetRectangleBanner(11, 11, 11, 1)
    rPolicef5Renfort:SetRectangleBanner(11, 11, 11, 1)
    rPolicef5Soutien:SetRectangleBanner(11, 11, 11, 1)
    rPolicef5Chien:SetRectangleBanner(11, 11, 11, 1)
...
function Rechercherplaquevoiture(plaquerechercher)
    ...
    PlaqueMenu:SetRectangleBanner(11, 11, 11, 1)
...
function OpenPrendreMenu()
    ...
    PrendreMenu:SetRectangleBanner(11, 11, 11, 1)
...
function Coffrepolice()
    ...
    Cpolice:SetRectangleBanner(11, 11, 11, 1)
...
function vestiairepolice()
    ...
    Vpolice:SetRectangleBanner(11, 11, 11, 1)
...
function Garagepolice()
  ...
  Gpolice:SetRectangleBanner(11, 11, 11, 1)
...
function Helipolice()
    ...
    Hpolice:SetRectangleBanner(11, 11, 11, 1)
...
function FRetirerobjet()
    ...
    Stockpolice:SetRectangleBanner(11, 11, 11, 1)
...
function ADeposerobjet()
    ...
    StockPlayer:SetRectangleBanner(11, 11, 11, 1)
...
function PCoffreRetirerWeapon()
    ...
    StockCoffreWeapon:SetRectangleBanner(11, 11, 11, 1)
    ESX.TriggerServerCallback('rPolice:getArmoryWeapons', function(weapons)
    Weaponstock = weapons
                ...
                RageUI.IsVisible(StockCoffreWeapon, true, true, true, function()
                        for k,v in pairs(Weaponstock) do 
                            ...
                            RageUI.ButtonWithStyle("~r~→~s~ "..ESX.GetWeaponLabel(v.name), nil, {RightLabel = v.count}, true, function(Hovered, Active, Selected)
                                if Selected then
                                    ESX.TriggerServerCallback('rPolice:removeArmoryWeapon', function()
                                        PCoffreRetirerWeapon()
                                    end, v.name)
                                end
                            end)
...
function PCoffreDeposerWeapon()
    ...
    StockPlayerWeapon:SetRectangleBanner(11, 11, 11, 1)
            ...
            RageUI.IsVisible(StockPlayerWeapon, true, true, true, function()
                ...
                for i=1, #weaponList, 1 do
                    ...
                    RageUI.ButtonWithStyle("~r~→~s~ "..weaponList[i].label, nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
                        ...
                        ESX.TriggerServerCallback('rPolice:addArmoryWeapon', function()
                            PCoffreDeposerWeapon()
...
function plaintepolice()
    ...
    Ppolice:SetRectangleBanner(11, 11, 11, 1)
